% F03_B.m
% Manuscript Fig 3b: spatial correspondence by ROI.
% Input tables are read from manuscript_figure_source_data/data/main_text_source_data.xlsx.
clear all
ROI={"Dorsal", "Lateral","Ventral"}

%% read dataTables
Fig3b=read_main_text_source_table("fig3b_points"); % includes all 5 seeds, averaged
Fig3b_noiseCeiling=read_main_text_source_table("fig3b_noise");
%% get all models
...
%% plot Fig 3b
Fig3bFig=figure('Color', [1 1 1], 'Units','normalized','Position',[ 0.1 0.1 .6 .6],'Name','Fig3b')
% dorsal
h1=subplot(1,3,1); 
hold on;
...
bar(xvals(7),mean_d(7),'FaceColor',gold,'BarWidth',.95,'EdgeColor',"none",'FaceAlpha',.75)
bar(xvals(8),mean_d(8),'FaceColor',mpurple,'BarWidth',.95,'EdgeColor',"none",'FaceAlpha',1.0)
...
bar(xvals(7),mean_l(7),'FaceColor',gold,'BarWidth',.95,'EdgeColor',"none",'FaceAlpha',.7)
bar(xvals(8),mean_l(8),'FaceColor',mpurple,'BarWidth',.95,'EdgeColor',"none",'FaceAlpha',1.0)
...
bar(xvals(7),mean_v(7),'FaceColor',gold,'BarWidth',.95,'EdgeColor',"none",'FaceAlpha',.75)
bar(xvals(8),mean_v(8),'FaceColor',mpurple,'BarWidth',.95,'EdgeColor',"none",'FaceAlpha',1.0)
...
%% savefig
exportgraphics(Fig3bFig,'Fig3b_checkpoint0_061426.tif','Resolution', 600);

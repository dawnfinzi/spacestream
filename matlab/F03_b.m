...
%% read dataTables
Fig3b=readtable("new_Fig3b_dataFrame_checkpoint0.csv");
Fig3b_noiseCeiling=readtable("new_Fig3b_noiseCeiling_checkpoint0.csv");
%% get all models
% Specify column names and types
disp(Fig3b.Properties.VariableNames);
allmodels =unique(Fig3b.model_type);
allmodels
%%
allmodels=allmodels([6 4 5 9 8 7 3 1 2])% re-order models so plots make sense
nmodels=length(allmodels);

Dorsal_i=find(Fig3b.ROIS=="Dorsal");
Dorsal=Fig3b(Dorsal_i,:);
Lateral_i=find(Fig3b.ROIS=="Lateral");
Lateral=Fig3b(Lateral_i,:);
Ventral_i=find(Fig3b.ROIS=="Ventral");
Ventral=Fig3b(Ventral_i,:);
...
for r=1:length(ROI)
    roi_i=find(Fig3b_noiseCeiling.ROI==ROI{r});
    mean_noise(r)=mean(Fig3b_noiseCeiling.result(roi_i));
    sd_noise(r)=std(Fig3b_noiseCeiling.result(roi_i));
end
...
%% plot Fig 3b
Fig3=figure('Color', [1 1 1], 'Units','normalized','Position',[ 0.1 0.1 .75 .7],'Name','Fig3b')
...
bar(xvals(7),mean_d(7),'FaceColor',mgreen,'BarWidth',.95,'EdgeColor',mgreen,'Linewidth',8,'FaceAlpha',.5)
bar(xvals(8),mean_d(8),'FaceColor',mblue,'BarWidth',.95,'EdgeColor',"none",'FaceAlpha',.5)
bar(xvals(9),mean_d(9),'FaceColor',mred,'BarWidth',.95,'EdgeColor',"none",'FaceAlpha',.5)

for i=1:nmodels

    text(xvals(i), .005,model_names(i), 'Rotation',90,'Color', [ 1 1 1],'FontSize',24,'FontName','Helvetica')
end
...
bar(xvals(7),mean_l(7),'FaceColor',mgreen,'BarWidth',.95,'EdgeColor',"none",'FaceAlpha',.5)
bar(xvals(8),mean_l(8),'FaceColor',mblue,'BarWidth',.95,'EdgeColor',mblue,'Linewidth',8,'FaceAlpha',.5)
...
bar(xvals(7),mean_v(7),'FaceColor',mgreen,'BarWidth',.95,'EdgeColor',"none",'FaceAlpha',.5)
bar(xvals(8),mean_v(8),'FaceColor',mblue,'BarWidth',.95,'EdgeColor',"none",'FaceAlpha',.5)
bar(xvals(9),mean_v(9),'FaceColor',mred,'BarWidth',.95,'EdgeColor',mred,'Linewidth',8,'FaceAlpha',.5)

for i=1:nmodels
    text(xvals(i), .005,model_names(i), 'Rotation',90,'Color', [ 1 1 1],'FontSize',24)
end
...
%% savefig
exportgraphics(Fig3,'Fig3b.tif','Resolution', 600);
